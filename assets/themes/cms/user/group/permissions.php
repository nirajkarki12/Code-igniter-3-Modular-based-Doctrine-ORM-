        ...
        <div class="col-xs-12">
            <div class="box box-solid box-sm">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Group Permissions <em>(<?php echo $group->getName();?>)</em></h3>
                </div><!-- /.box-header -->
								...
								<tr>
									<td>
					        			...
					        			<input id="<?php echo str_replace(' ', '-', $name); ?>" 
				        				   ...
				        				   <?php echo $chk;?> 
				        				   class="checkIt <?php echo ucfirst($module); if ($chk != '') echo ' default'?> " />
					        		</td>
                    ...
                    <div class="box-footer clearfix">
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
        						...
        						<!-- <a href="<?php echo site_url('user/group/permissions/'.$group->getId())?>" class="btn btn-danger">Cancel</a> -->
                            </div>
                        </div>
                    </div>
                </form>
